...
NTSTATUS FileSystemHost::mount(const std::wstring& path,const std::wstring& index_path,const std::wstring& storage_root,const std::wstring& owner_sid,bool cache_mode,std::uint64_t volume_total_bytes,std::uint64_t volume_free_bytes,const std::wstring& origin_root){
